...
The Tour uses [FocusScope](https://react-spectrum.adobe.com/react-aria/FocusScope.html) in order to lock the focus iteration inside the [Popover](/popover) when _Tour_ is active. This prop disables this behaviour.
