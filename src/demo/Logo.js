    ...
    <svg viewBox="0 0 364 419.2">
      <g data-tut="reactour__logo">
        ...
        <Shake elem="g" dur={10000} int={4} h={0} v={5} r={3} max={70} fixed>
          <path opacity=".2" fill="#FFF" d="M276.2 157.1c-1.3-10.8-2.2-37.8-24-44.7-21.8-6.9-40.3-10-70.1-10-29.8 0-48.3 3.1-70.1 10-21.8 6.9-22.7 33.9-24 44.7-1.3 10.8 9.8 10.4 9.8 10.4h168.8c-.1 0 11 .4 9.6-10.4z"/>
          ...
          <circle fill="#FFF" fillOpacity=".2" stroke="#FFF" strokeWidth="2" strokeMiterlimit="10" cx="105.4" cy="235.6" r="16.7"/>
          ...
          <path d="M107.7 326.9H84.4c-2.7 0-4.8-2.1-4.8-4.8v-25.7c0-2.7 2.1-4.8 4.8-4.8h23.3c2.7 0 4.8 2.1 4.8 4.8v25.7c0 2.6-2.1 4.8-4.8 4.8zm171.7 0H256c-2.7 0-4.8-2.1-4.8-4.8v-25.7c0-2.7 2.1-4.8 4.8-4.8h23.3c2.7 0 4.8 2.1 4.8 4.8v25.7c.1 2.6-2.1 4.8-4.7 4.8z" fill="#2D2323"/>
          ...
          <circle fill="#FFF" fillOpacity=".2" stroke="#FFF" strokeWidth="2" strokeMiterlimit="10" cx="258.1" cy="235.6" r="16.7"/>
        </Shake>
      </g>
      { iso && (
