  ...
  },
  {
    ...
    content: () => (
      <div>        
        ...
        <Text color="#e5e5e5">
          The <Tooltip data-tooltip="this helper ⬇">tourist guide</Tooltip> could be dressed in any way, using custom components, styles and so on…
        </Text>
    ...
    content: ({ goTo }) => (
      <div>
        ...
        <br /> "Oh, I forgot something inside the bus…" <button 
          ...
          onClick={() => goTo(1)}>Please go back to 🚌</button>
      </div>
    )
  },
  {
    ...
    content: () => (
      <Text>
        ...
        <br/> In this case will try to stay in the <strong>left side</strong> if there's available space, otherwise will <strong>auto position</strong>.
      </Text>
    ),
    position: 'left'
  },
