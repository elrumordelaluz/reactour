...
const tourConfig = [
        ...
        content: function DemoHelperComponent() {
            return (
                <div>
                    ...
                    <Text color="#e5e5e5">
                        The <Tooltip data-tooltip="this helper ⬇">tourist guide</Tooltip> could be dressed in any way,
                        using custom components, styles and so on…
                    </Text>
    ...
    },
    {
        ...
        content: function DemoHelperComponent() {
            return (
                <Text>
                    The <Tooltip data-tooltip="this helper ⬇">tourist guide</Tooltip> could be positioned where you
                    want.
                    <br />
